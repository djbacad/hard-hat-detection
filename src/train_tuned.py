...
# Run the script and write output to tuning_output txt file: 
## python train_tuned.py > tuning_output.txt
...
# The tuning process is also set to run for only 5 trials, 10 epochs each.
